...
export const PAYMENT_CONFIG: Record<string, Omit<PaymentServiceConfig, 'previewComponent'>> = {
    ...
    fidelity: {
        ...
        subtitle: 'Private Chat Analysis',
        badgeText: '🔒 Private Report Ready',
        singleReportName: '💬 Fidelity Test Report',
        ...
        features: [
            { name: '💬 Chat Screenshot Review', description: 'Analyze uploaded messages after payment' },
            { name: '🧠 Gemini AI Analysis', description: 'Detect possible conversation patterns carefully' },
            { name: '🔒 Private Report', description: 'Locked report shown only after checkout' },
            { name: '📊 Trust Signals', description: 'Summary, score, moments, and questions to ask' },
        ],
    },
    chatAnalysis: {
        title: 'Chat Analysis',
